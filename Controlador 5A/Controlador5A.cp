...
void rotateMotor(){
 ...
 duty_cycle1 = map(pulseWidth1,MIN_CH1_DURATION,MAX_CH1_DURATION, -255 , 255 );
 duty_cycle2 = map(pulseWidth2,MIN_CH2_DURATION,MAX_CH2_DURATION, -255 , 255 );
